...
// const uri = `mongodb+srv://:@main.mq0mae1.mongodb.net/?retryWrites=true&w=majority&appName=Main`;
...
async function run() {
  try {
    const db = client.db("stayVistaB9");
    ...
    // get all users data from db --> verifyToken, verifyAdmin,
    ...
    app.get("/admin-stat", verifyToken, verifyAdmin, async (req, res) => {
      ...
      const chartArt = bookingDetails.map((booking) => {
